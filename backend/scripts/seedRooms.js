...
mongoose.connect('mongodb+srv://harshguleri5:heena05@cluster0.icvpvgr.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0', {
  useNewUrlParser: true,
  useUnifiedTopology: true,
});

const rooms = [ 
  // Paste your entire `items` array here (modify it slightly to remove trailing commas)
  {
            id: 1,
